      ...
      >
        ...
        <defs>
          <linearGradient id="sharedGradient" x1="0%" x2="100%" y1="0%" y2="0%">
            <stop offset="0%" stopColor="rgba(255, 91, 34, 0.72)" />
            <stop offset="50%" stopColor="rgba(201, 237, 255, 0.48)" />
        ...
        <g className="secondary-waves" style={{ opacity: 0.8 }}>
          {secondaryPaths.map((path) => (
            <motion.path
              animate={reduceMotion ? { opacity: 0.3, scale: 1 } : {
                ...sharedAnimationProps,
                y: [0, -10, 0],
              }}
              d={path.d}
...
export function BackgroundPathLines() {
  return <div className="hero-paths" aria-hidden="true"><FloatingPaths position={1} /></div>;
}
